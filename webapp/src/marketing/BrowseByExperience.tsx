          ...
          {families.map((family, idx) => (
            ...
            >
              <Link
                ...
                className="group relative flex h-72 flex-col justify-end overflow-hidden rounded-[28px] border border-black/[0.06] shadow-[var(--m-shadow-premium-sm)] transition-shadow duration-300 hover:shadow-[var(--m-shadow-premium-lg)] sm:h-80"
              >
