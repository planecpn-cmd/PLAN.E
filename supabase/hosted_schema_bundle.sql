...
-- 0004 (interests, regions, categories). It does NOT contain the
-- experience catalog, which lives in supabase/seed.sql.
--
-- APPLY ONLY TO AN EMPTY DATABASE. Tables use bare CREATE TABLE and the
-- 0004 inserts have no ON CONFLICT clause, so running this against a
-- database that already has the schema aborts on a duplicate object or
