-- Supabase Dev Seed Data (~30 Real Nepal Experiences)
do $$
declare
  v_cat_trekking uuid;
  v_cat_hiking uuid;
...
begin
  ...
  -- Clear existing dev experiences for clean seed reset
...
-- booking Edge Functions validate these IDs server-side.
...
-- Keep seeded covers consistent with database-owned catalog photography.
-- Licensed catalog photographs are owned by the database, not individual screens.
-- Source/license records: docs/IMAGE_SOURCES.json.
-- Upload matching WebP files to catalog-images before applying these references.
-- Match reviewed titles and previous covers to preserve independently edited listings.
update public.experiences as e
set cover_image_url = photo.new_url
from (values
  ('annapurna-base-camp-trek', 'Annapurna Base Camp Trek', 'https://images.unsplash.com/photo-1585016495481-91613a3ab1bc?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_14663618.webp'),
  ('australian-camp-overnight', 'Australian Camp & Dhampus Himalayan Camping', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_10807657.webp'),
  ('australian-camp-overnight', 'Dhampus Campfire Community Night', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_10807657.webp'),
  ('bandipur-cultural-walk', 'Bandipur Living Culture Experience', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_13319054.webp'),
  ('bandipur-cultural-walk', 'Bandipur Living Museum Newari Cultural Experience', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_13319054.webp'),
  ('bardia-tiger-tracking', 'Bardia National Park Wild Tiger Tracking Expedition', 'https://images.unsplash.com/photo-1534177616072-ef7dc120449d?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_8241416.webp'),
  ('bardia-tiger-tracking', 'Bardia Wildlife Conservation Day', 'https://images.unsplash.com/photo-1534177616072-ef7dc120449d?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_8241416.webp'),
  ('bhaktapur-pottery-workshop', 'Bhaktapur Living Heritage & Pottery Workshop', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_20088012.webp'),
  ('bhaktapur-pottery-workshop', 'Bhaktapur Pottery Workshop', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_20088012.webp'),
  ('bhotekoshi-whitewater-rafting', 'Bhotekoshi Class III-IV White Water Rafting Adventure', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_31758766.webp'),
  ('bhotekoshi-whitewater-rafting', 'Bhotekoshi White Water Rafting', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_31758766.webp'),
  ('chitwan-jungle-safari', 'Chitwan Wildlife Safari & Tharu Culture', 'https://images.unsplash.com/photo-1534177616072-ef7dc120449d?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_36096444.webp'),
  ('chitwan-jungle-safari', 'Chitwan Wildlife and Culture Tour', 'https://images.unsplash.com/photo-1534177616072-ef7dc120449d?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_36096444.webp'),
  ('dhulikhel-namobuddha-hike', 'Dhulikhel to Namobuddha Sacred Stupa Hike', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34766892.webp'),
  ('dhulikhel-namobuddha-hike', 'Namobuddha Mindfulness Retreat', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_6787406.webp'),
  ('everest-base-camp-trek', 'Everest Base Camp Trek', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_8163772.webp'),
  ('everest-heli-tour', 'Everest Base Camp Helicopter Tour with Champagne Breakfast', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34912011.webp'),
  ('everest-heli-tour', 'Everest Helicopter Tour', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34912011.webp'),
  ('ghandruk-homestay-experience', 'Ghandruk Heritage Village & Homestay', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_18647876.webp'),
  ('ghandruk-homestay-experience', 'Ghandruk Village Homestay', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_18647876.webp'),
  ('gokyo-lakes-trek', 'Gokyo Community Clean-up Project', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_9543400.webp'),
  ('gokyo-lakes-trek', 'Turquoise Gokyo Lakes & Gokyo Ri Summit Trek', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_24959911.webp'),
  ('helambu-circuit-trek', 'Helambu Hyolmo Heritage Circuit Trek', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34700366.webp'),
  ('helambu-circuit-trek', 'Helambu School Support Week', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_11599230.webp'),
  ('himalayan-sound-healing', 'Himalayan Singing Bowl Sound Healing & Meditation', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_3544322.webp'),
  ('himalayan-sound-healing', 'Himalayan Sound Healing', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_3544322.webp'),
  ('island-peak-climbing', 'Island Peak (Imja Tse) 6,189m Mountaineering Expedition', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_5011236.webp'),
  ('island-peak-climbing', 'Island Peak Climbing Expedition', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_5011236.webp'),
  ('kakani-trout-strawberry', 'Kakani Farm and Food Day Trip', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_7457199.webp'),
  ('kakani-trout-strawberry', 'Kakani Hilltop Rainbow Trout & Organic Strawberry Tasting', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_7457199.webp'),
  ('langtang-valley-trek', 'Langtang Mindfulness Retreat', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_3059892.webp'),
  ('langtang-valley-trek', 'Langtang Valley & Kyanjin Gompa Trek', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_16681482.webp'),
  ('manaslu-circuit-trek', 'Manaslu Circuit & Larkya La Pass Trek', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_24486626.webp'),
  ('manaslu-circuit-trek', 'Manaslu Travelers Community Evening', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_11339115.webp'),
  ('mardi-himal-trek', 'Mardi Himal High Ridge Trek', 'https://images.unsplash.com/photo-1585016495481-91613a3ab1bc?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_4032145.webp'),
  ('mardi-himal-trek', 'Pokhara Sunrise Social Walk', 'https://images.unsplash.com/photo-1585016495481-91613a3ab1bc?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_19877800.webp'),
  ('mera-peak-climbing', 'Mera Peak 6,476m Highest Trekking Peak Expedition', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_37358046.webp'),
  ('mera-peak-climbing', 'Mountain Safety Skill-Sharing Project', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_6677380.webp'),
  ('nagarkot-sunrise-hike', 'Nagarkot Himalayan Sunrise & Changunarayan Day Hike', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_419530.webp'),
  ('nagarkot-sunrise-hike', 'Nagarkot Sunrise Day Trip', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_419530.webp'),
  ('panauti-community-homestay', 'Panauti Community Homestay', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_20434913.webp'),
  ('panauti-community-homestay', 'Panauti Community Organic Homestay', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_20434913.webp'),
  ('phulchowki-mountain-biking', 'Kathmandu Cycling Social', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_5807633.webp'),
  ('phulchowki-mountain-biking', 'Phulchowki 2,760m Mountain Bike Singletrack Descent', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_5807633.webp'),
  ('pokhara-paragliding', 'Pokhara Tandem Paragliding', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34740796.webp'),
  ('pokhara-paragliding', 'Pokhara Tandem Paragliding over Fewa Lake', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34740796.webp'),
  ('pokhara-peace-stupa-hike', 'Pokhara Peace Stupa Day Tour', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_24389610.webp'),
  ('pokhara-peace-stupa-hike', 'World Peace Pagoda Boat & Forest Hike', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_24389610.webp'),
  ('rara-lake-wilderness-trek', 'Rara Lake Queen of Lakes Wilderness Trek', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_9586148.webp'),
  ('rara-lake-wilderness-trek', 'Rara Lakeside Yoga Weekend', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_29788527.webp'),
  ('shivapuri-peak-hike', 'Shivapuri Forest Meditation Morning', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_9225402.webp'),
  ('shivapuri-peak-hike', 'Shivapuri Peak & Nagi Gompa Nature Hike', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_12319272.webp'),
  ('tiji-festival-mustang', 'Lo Manthang Tiji Festival & Sacred Mask Dances', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_13404007.webp'),
  ('tiji-festival-mustang', 'Tiji Festival Cultural Experience', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_13404007.webp'),
  ('tilicho-lake-annapurna-circuit', 'Tilicho High Lake & Thorong La Pass Circuit', 'https://images.unsplash.com/photo-1585016495481-91613a3ab1bc?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_6359258.webp'),
  ('tilicho-lake-annapurna-circuit', 'Tilicho Watershed Conservation Project', 'https://images.unsplash.com/photo-1585016495481-91613a3ab1bc?q=80&w=1000', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_9543734.webp'),
  ('upper-mustang-trek', 'Mustang Culture Exchange Meetup', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_11398341.webp'),
  ('upper-mustang-trek', 'Upper Mustang Forbidden Kingdom Trek', 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=800', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34022824.webp')
) as photo(slug, title, old_url, new_url)
where e.slug = photo.slug and e.title = photo.title
  and e.cover_image_url = photo.old_url;

update public.experience_families as f
set cover_image_url = photo.new_url
from (values
  ('adventure-together', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_20315033.webp'),
  ('give-back', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_11599230.webp'),
  ('live-like-a-local', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_11052970.webp'),
  ('meet-people', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_28657144.webp'),
  ('mind-soul', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_9257175.webp'),
  ('trips-tours', 'https://dtebgbrqynxahuzmbtbc.supabase.co/storage/v1/object/public/catalog-images/plane-catalog-upload/photo_34973191.webp')
) as photo(slug, new_url)
where f.slug = photo.slug and f.cover_image_url is null;
