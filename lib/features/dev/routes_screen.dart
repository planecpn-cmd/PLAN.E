...
class DevRoutesScreen extends StatelessWidget {
  ...
  static const List<Map<String, String>> routes = [
    ...
    {'id': 'PL-11', 'name': 'Booking Confirmation', 'path': '/booking/confirmation/1'},
    {'id': 'PL-12', 'name': 'Saved Experiences', 'path': '/saved'},
    {'id': 'PL-13/14', 'name': 'My Plans (Upcoming / Drafts)', 'path': '/plans'},
    ...
    {'id': 'PL-15/16', 'name': 'My Trips (Completed / Cancelled)', 'path': '/trips'},
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            leading: CircleAvatar(
              child: Text(route['id']!.split('-').first),
            ),
