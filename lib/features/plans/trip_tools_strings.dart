abstract class TripToolsStrings {
  // Chat Strings
  static const String tripChatTitle = 'Trip Group Chat';
  static const String chatEmptyTitle = 'No Messages Yet';
  static const String chatEmptyDesc =
      'Connect with your verified local host, trekking guide, and fellow trail companions!';
  ...
  static const String messageSentError = 'Could not send message. Saved to local outbox.';
  ...
  static const String gearEmptyDesc = 'Add gear items to keep track of your packing list.';
  static const String addGearButton = 'Add Custom Item';
  static const String addGearDialogTitle = 'Add Gear Checklist Item';
  static const String gearItemLabelHint = 'Item name (e.g. Sleeping Bag, Headlamp)';
  ...
  static const String budgetTrackerTitle = 'Trip Budget Tracker';
  ...
  static const String budgetEmptyDesc =
      'Log on-trail expenses, meals, permits, and tips to keep track of your trip budget.';
  static const String addExpenseButton = 'Log New Expense';
  static const String addExpenseDialogTitle = 'Log Trip Expense';
  static const String expenseLabelHint = 'Expense description (e.g. Tea house dinner)';
